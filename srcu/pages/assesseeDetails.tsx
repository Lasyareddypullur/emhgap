...
const AssesseeDetails: React.FC = () => {
  ...
  const handleSubmit = async () => {
    console.log("Submitting data:", { name, age, gender, qualification, job, phone, parentname, parentno, monthlysavings, area, namearea, housing, otherillness, disease });
    try {
      const docRef = doc(db, "details", documentId);
      const docSnap = await getDoc(docRef);
